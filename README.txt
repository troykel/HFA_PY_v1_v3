...
3. Choose where to save it (like your Desktop folder)

4. Open the new folder that was created

5. Double-click HuemanityForALL.exe to start the app
...
FAVORITES
   ...
   Use "Favorites Only" to filter to just your saved palettes
...
App won't start
   - Make sure you unzipped the folder first(right-click, then Extract All)
   - Make sure you didn't move or delete any files

Windows Defender warning
   - This is normal for new/independent software
...
Website:  troyskidesigns.io (coming soon)
Gumroad:  troyskidesigns.gumroad.com

--------------------------------------------------------------------------------
LICENSE
--------------------------------------------------------------------------------

Copyright (c) 2025-2026 Troy (Troyski). All Rights Reserved.
